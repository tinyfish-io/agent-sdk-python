...
from ._exceptions import TinyfishError, APIStatusError
...
class Tinyfish(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Tinyfish client instance.

        This automatically infers the `api_key` argument from the `TINYFISH_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("TINYFISH_API_KEY")
        if api_key is None:
            raise TinyfishError(
                "The api_key client option must be set either by passing api_key to the client or by setting the TINYFISH_API_KEY environment variable"
            )
    ...
    @cached_property
    def with_raw_response(self) -> TinyfishWithRawResponse:
        return TinyfishWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> TinyfishWithStreamedResponse:
        return TinyfishWithStreamedResponse(self)
...
class AsyncTinyfish(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncTinyfish client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncTinyfishWithRawResponse:
        return AsyncTinyfishWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncTinyfishWithStreamedResponse:
        return AsyncTinyfishWithStreamedResponse(self)
...
class TinyfishWithRawResponse:
    _client: Tinyfish

    def __init__(self, client: Tinyfish) -> None:
        self._client = client
...
class AsyncTinyfishWithRawResponse:
    _client: AsyncTinyfish
...
class TinyfishWithStreamedResponse:
    _client: Tinyfish
...
class AsyncTinyfishWithStreamedResponse:
    _client: AsyncTinyfish
